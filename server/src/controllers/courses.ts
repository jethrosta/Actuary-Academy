...
import { createCourse, Courses, CourseById, CourseBySubscriberId, subscribeToCourse } from '../db/courses';
import type { CourseDocument } from '../db/courses'
...
export const updateNewCourseSubscriber = async (req: CourseRequest & RequestWithJWT, res: express.Response) => {
  try {
    const id = req.userId
