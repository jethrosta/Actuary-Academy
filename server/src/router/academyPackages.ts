...
import { addProduct, getAllProducts, getProductById, getProductByName, updateProductById, deleteProduct } from "../controllers/academyPackages";

export default (router: express.Router) => {
    router.post('/v2/academy', addProduct);
    router.get('/v2/academy', getAllProducts);
    router.get('/v2/academy/:id', getProductById);
    router.get('/v2/academy/:name', getProductByName);
