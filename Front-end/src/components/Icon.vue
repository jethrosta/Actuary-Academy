...
<template>
    <template v-if="name === 'account'">
        <svg class="stroke-current" :width="size" :height="size" viewBox="0 0 30 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
    ...
    <template v-if="name === 'purchase'">
        <svg class="stroke-current" :width="size" :height="size" viewBox="0 0 35 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
    ...
    <template v-if="name === 'logout'">
        <svg class="stroke-current" :width="size" :height="size" viewBox="0 0 35 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
    ...
    <template v-if="name === 'video'">
        <svg class="stroke-current" :width="size" :height="size" viewBox="0 0 90 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
    ...
    <template v-if="name === 'file'">
        <svg class="stroke-current" :width="size" :height="size" viewBox="0 0 80 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
